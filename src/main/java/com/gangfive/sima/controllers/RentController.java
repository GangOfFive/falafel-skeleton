...
import com.gangfive.sima.contracts.RentItemsResponse;
import com.gangfive.sima.contracts.RentResponse;
...
import com.gangfive.sima.utils.Utils;
...
public class RentController {
	...
	public RentItemsResponse getAll(){
		...
		int idUser = Integer.parseInt(currentSession.getAttribute("idUser").toString());
